...
using Skolplattformen.ElevApp.SkolplattformenApi.Models.Internal.Kalendarium;
using Skolplattformen.ElevApp.SkolplattformenApi.Utils;
...
public partial class Api
{
    public async Task<List<KalendariumItem>> GetKalendariumAsync()
    {
        ...
        var part = ApiPart.GetKalendarium;
