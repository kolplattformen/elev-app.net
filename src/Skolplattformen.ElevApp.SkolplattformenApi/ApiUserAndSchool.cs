...
using Skolplattformen.ElevApp.SkolplattformenApi.Models.Internal.StockholmAzureApi;
...
public partial class Api
{
    ...
    public async Task<ApiUser?> GetUserAsync()
    {
        ...
        try
        {
            ...
            UpdateStatus(part, string.IsNullOrEmpty(user.Name) 
                ? ApiReadSuccessIndicator.NoData
                :ApiReadSuccessIndicator.Success);
    ...
    public async Task<List<Teacher>> GetTeachersAsync()
    {
        ...
        try
        {
            ...
            UpdateStatus(part, teacherList.Count > 0 ? ApiReadSuccessIndicator.Success: ApiReadSuccessIndicator.NoData);
            return teacherList;
        }
        catch
        {
    ...
    public async Task<SchoolDetails?> GetSchoolDetailsAsync(Guid schoolId)
    {
        ...
        var part = ApiPart.GetSchoolDetails;
        ...
        try
        {
            ...
            UpdateStatus(part, string.IsNullOrEmpty(schoolDetails.Name)
                ? ApiReadSuccessIndicator.NoData
                : ApiReadSuccessIndicator.Success);
